...
class TeamFavoriteRepositoryTest {

    private lateinit var dbHelper: DbHelper
    private lateinit var favoriteRepository: TeamFavoriteRepository
    private lateinit var team: Team

    @Before
    fun setUp() {
        favoriteRepository = TeamFavoriteRepository(ApplicationProvider.getApplicationContext())
    ...
    @Test
    fun `create team favorite, when new data given, should return non negative number`() {

        val createTeamFavorite = favoriteRepository.createTeamFavorite(
            teamId = team.idTeam.toString(),
            teamName = team.strTeam.toString(),
            teamBadge = team.strTeamBadge.toString(),
            teamManager = team.strManager.toString(),
            teamStadium = team.strStadium.toString(),
            teamDescription = team.strDescriptionEN.toString())

        val testSubscriber = TestSubscriber<Long>()
        createTeamFavorite.subscribe(testSubscriber)

        val result = testSubscriber.values()[0]
        assertThat(result, `is`(Matchers.greaterThan(-1L)))
    }

    @Test
    fun `create team favorite, when duplicate team id given, should return negative number`() {

        favoriteRepository.createTeamFavorite(
            teamId = team.idTeam.toString(),
            teamName = team.strTeam.toString(),
            teamBadge = team.strTeamBadge.toString(),
            teamManager = team.strManager.toString(),
    ...
    @Test
    fun `delete team favorite, when data available, should return true`() {
        ...
        val deleteTeamFavorite = favoriteRepository.deleteTeamFavorite("133604")

        val testSubscriber = TestSubscriber<Boolean>()
        deleteTeamFavorite.subscribe(testSubscriber)
    ...
    @Test
    fun `delete team favorite, when data not available, should return false`() {

        val deleteTeamFavorite = favoriteRepository.deleteTeamFavorite("000000")
    ...
    @Test
    fun `get a team favorite, when data available, should return result`() {

        val expectedResult = Team(
            idTeam = team.idTeam.toString(),
            strTeam = team.strTeam.toString(),
            strTeamBadge = team.strTeamBadge.toString(),
            strManager = team.strManager.toString(),
            strStadium = team.strStadium.toString(),
            strDescriptionEN = team.strDescriptionEN.toString(),
            strSport = team.strSport.toString())
        ...
        val getTeamFavorite = favoriteRepository.getTeamFavorite("133604")

        val testSubscriber = TestSubscriber<Team>()
        getTeamFavorite.subscribe(testSubscriber)
    ...
    @Test
    fun `get a team favorite, when data not available, should return empty result`() {

        val expectedResult = Team()

        val getTeamFavorite = favoriteRepository.getTeamFavorite("000000")
    ...
    @Test
    fun `get all team favorite, when data available, should return result`() {
        ...
        val getAllTeamFavorite = favoriteRepository.getAllTeamFavorite()

        val testSubscriber = TestSubscriber<List<Team>>()
        getAllTeamFavorite.subscribe(testSubscriber)
    ...
    @Test
    fun `get all team favorite, when data not available, should return empty result`() {
